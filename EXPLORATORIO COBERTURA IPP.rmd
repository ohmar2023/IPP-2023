...
* El cálculo del tamaño para una submuestra se lo ha realizado a manera de ejercicio, sin embargo, cabe aclarar que debido a la deficincia en la cobertura estos resultados no pueden ser considerados como definitivos. Adicionalmente, no se contaron con los precios levantados en la prueba piloto, los datos facilitados sirven unicamente como ejemplo.
