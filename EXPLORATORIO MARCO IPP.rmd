...
Podemos observar la disponibilidad de cada producto (Código CIIU Rev 4 - 6 dígitos) en cada uno de los tamaños de empresa.
...
La tasa de no respuesta, usada para el cálculo, fue definida como el promedio de las TNR correspondientes a los dominios "3C & 4C":
...
Se subdivide a la actividad principal C en los dominios 2C, 3C y 4C:
...
```{r, message = FALSE,echo = FALSE}
caso_2 <- Tam_Total[!grepl(Tam_Total$dominio,pattern = "C"), ]%>% 
rename("Dominio" = dominio) 
